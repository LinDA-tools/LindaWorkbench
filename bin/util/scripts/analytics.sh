...
mvn clean install -X
cp -r configuration/lindaAnalytics/ ~/LinDA/Analytics/wildfly/modules/lindaAnalytics
cp target/RESTfulLINDA.war ~/LinDA/Analytics/wildfly/standalone/deployments/
