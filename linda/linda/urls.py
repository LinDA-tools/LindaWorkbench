...
urlpatterns = patterns('',
	...
	url(r'^vocabulary/(?P<pk>\d+)/edit/', views.VocabularyUpdateView.as_view(), name='vocabulary-edit'),
	url(r'^vocabulary/(?P<pk>\d+)/delete/', views.VocabularyDeleteView.as_view(), name='vocabulary-delete'),
