...
SECRET_KEY = '4r#^zaxm^7jd-4i5natjk_@-*lx0lxj&amp;c_tsnku_k!qn+-4wiz'
...
PRIVATE_SPARQL_ENDPOINT =  'http://localhost:8080/openrdf-sesame/repositories/linda' # 'http://dbpedia.org/sparql'
